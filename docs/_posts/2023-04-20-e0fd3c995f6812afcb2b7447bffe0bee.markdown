---
layout: post
title:  "Sentiment analysis of the attorney general s office performance in handling corruption cases on twitter using naïve bayes classification algorithm"
